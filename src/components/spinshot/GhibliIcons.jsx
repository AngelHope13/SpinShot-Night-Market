...
export const GhibliClock = ({ className = "w-6 h-6" }) => (
  <svg viewBox="0 0 48 48" className={className} fill="none">
    {/* Soft dreamy glow */}
    <ellipse cx="25" cy="26" rx="22" ry="20" fill="url(#clock-glow)" opacity="0.5" />
    
    {/* Pocket watch chain - slightly curved and delicate */}
    <path
      ...
      fill="none"
    />
    <circle cx="24" cy="8" r="1.8" fill="white" opacity="0.85" />
    
    {/* Main pocket watch body - tilted slightly */}
    <ellipse 
      cx="25" 
      cy="26" 
      rx="12" 
    ...
    {/* Clock hands - minimal and elegant */}
    <line 
      x1="25" y1="26" x2="25" y2="18" 
      stroke="white" 
      strokeWidth="2" 
      strokeLinecap="round" 
      opacity="0.9"
    ...
    {/* Center button */}
    <circle cx="25" cy="26" r="2" fill="white" opacity="0.95" />
    
    {/* Floating sparkles around the watch */}
    <circle cx="12" cy="20" r="1.8" fill="white" opacity="0.7" />
    <circle cx="38" cy="22" r="1.5" fill="white" opacity="0.6" />
    <circle cx="16" cy="34" r="1.3" fill="white" opacity="0.65" />
    <circle cx="36" cy="32" r="1.6" fill="white" opacity="0.7" />
    
    {/* Gentle time swirl - magical flow */}
    <path
      d="M10 28 Q14 24, 18 26"
      stroke="white"
      strokeWidth="1.5"
      strokeLinecap="round"
      opacity="0.5"
    ...
    {/* Soft accent glow dots */}
    <circle cx="20" cy="16" r="1" fill="white" opacity="0.5" />
    <circle cx="32" cy="36" r="1" fill="white" opacity="0.5" />
